...
import HeroBannerImage from '../assets/images/bannerr.png';

const HeroBanner = () => (
  <Box sx={{ mt: { lg: '212px', xs: '70px' }, ml: { sm: '50px' } }} position="relative" p="20px">
    <Typography color="#3A2252" fontWeight="600" fontSize="26px">Fitness Club</Typography>
    <Typography fontWeight={700} color="#FF2325" sx={{ fontSize: { lg: '44px', xs: '40px' } }} mb="23px" mt="30px">
      Greatness <br /> On A <br />
      Different Level
    </Typography>
    <Typography fontSize="22px"  color="#3D2222" fontFamily="Alegreya" lineHeight="35px">
