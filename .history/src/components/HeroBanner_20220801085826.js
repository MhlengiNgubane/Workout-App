...
const HeroBanner = () => (
  <Box sx={{ mt: { lg: '212px', xs: '70px' }, ml: { sm: '50px' } }} position="relative" p="20px">
    <Stack>
      <a href="exercises" style={{ marginTop: '5px', textDecoration: 'none', width: '20px', textAlign: 'center', background: '#3A2252', padding: '14px', fontSize: '22px', textTransform: 'none', color: 'white', borderRadius: '4px' }}>Explore Exercises</a>
    </Stack>
